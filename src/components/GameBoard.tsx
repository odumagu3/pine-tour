              ...
              {seats.filter(s => s.pos !== 'South').map((seat) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold max-w-full truncate w-full text-center text-white">{seat.player.name}</span>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-left text-[9px] sm:text-[10px]">
                      <div className="font-bold max-w-[52px] sm:max-w-[80px] truncate text-white">{seat.player.name} {isMe && "(You)"}</div>
